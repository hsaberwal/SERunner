...
function EventWizard() {
  ...
  const addPerformer = () => {
    setEventData({
      ...eventData,
      performers: [...eventData.performers, { type: '', count: 1, input_source: '', notes: '', channels: [] }]
    })
  }
  ...
  const renderPhase5 = () => (
    <div className="phase-content">
      ...
      <div className="form-group">
        ...
        {showAddInstrument && (
          <div style={{ background: '#f0f9ff', border: '1px solid #bfdbfe', borderRadius: '0.5rem', padding: '0.75rem', marginTop: '0.5rem', marginBottom: '0.5rem' }}>
              ...
              <div className="channel-assignment">
                ...
                {performer.count > 1 && (
                  <span className="channel-hint">
                    💡 Set up Ch {performer.channels?.[0] || '?'}, copy to others
                  </span>
                )}
              </div>
            )}
