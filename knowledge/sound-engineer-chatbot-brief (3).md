...
### CJSA - Central Jersey Sikh Association (Gurdwara)

**Venue Type:** Gurdwara (Sikh temple)

**Speaker Setup (Permanent Install - All Flown):**
| Component | Details |
|-----------|---------|
| FOH Left | Ambisonic 6.5HD Line Array (6 modules) |
| FOH Right | Ambisonic 6.5HD Line Array (6 modules) |
| Subwoofers | 2x Ambisonic subwoofers |
| Mounting | All flown (suspended) |

**Line Array Characteristics:**
- Even SPL coverage front-to-back (+/- 3dB)
- Controlled vertical dispersion — focuses sound on congregation, not ceiling
- Wide horizontal dispersion for full coverage
- High intelligibility in reverberant spaces
...
**Saved Settings:**
- LR GEQ cuts: [To be documented]
- Monitor GEQ cuts: [To be documented]
- Successful setups: [To be logged in app]
...
The knowledge base document (`sound-knowledge-base.md`) is loaded and sent with every Claude API request. This gives the AI chatbot:
- EQ, compression, FX settings for all instruments
- Mic selection guidance
...
```
{
  ...
  "system": "<knowledge_base content here>",
  "messages": [
    {
      "role": "user", 
      "content": "Setup context + user question"
    }
  ]
}
```
