...
- Open a mic at typical performer position
...
**User's method:**
1. Turn on ALL mics, positioned where performers will stand
2. QuPac signal generator → pink noise → monitor output
3. Gradually increase monitor level
4. Watch RTA for peaks that sustain/ring
5. Cut those frequencies on **Monitor Mix GEQ**
6. Repeat until clean at performance level + headroom
